 ...
 * Αν η μία έχει λιγότερο από 1/4 καύσιμα
 * τότε ανάβει πορτοκαλί σήμα,
 * ενώ αν και οι δύο έχουν < 1/4 τότε
 * ανάβει κόκκινο σήμα.
 * Ο πιλότος δίνει true or false
 * ανάλογα αν δεξαμενή < 1/4 ή όχι, αντίστοιχα.
 */
