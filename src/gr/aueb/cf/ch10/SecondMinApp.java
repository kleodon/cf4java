...
public class SecondMinApp {
     ...
     * The area where both min and second min are * less than both current min and second min * and the area where min is greater than current * min whereas second min is less than second min.
     *
