 ...
 * We will develop a method int[] getLowAndHigh IndexOf(int[]
 ...
 * we insert 8 as key, the algorithm should return {7, 11} or {8, 12} * if we make a tiny user-friendly optimization.
 */
