...
/**
 * Encrypts strings (English Uppercase Alphabet) * based on Julius Caesar algorithm, shifting
 * the initial string k positions to the right. * Julius Caesar shifted three position to the right, * while Augustus Caesar shifted one RHS position.
 */
...
public class Crypto2 {
    ...
    /**
     * Decrypts a string with symmetric-like cryptography. * Shifts encrypted chars key-positions to the left.
     *
    ...
    /**
     * Encrypts an eng uppercase char based on a secret key.
     *
